...
export default function PhotographyCase() {
  ...
  return (
    <>
      <OrientationWarning />
      <ProjectSwitcher currentProject="Photography" />
      ...
      <AnimatePresence>
        {isLoading && (
          ...
          >
            ...
            >
              <h1 className="font-alice text-3xl text-[#333333] mb-4">Photography</h1>
        ...
        <div className={`flex-1 flex items-center justify-center ${isLandscape ? 'h-full pt-0' : isMobile ? 'pt-16' : 'pt-24 sm:pt-32'}`}>
          ...
          >
            {currentImage === totalImages ? (
              ...
              <Image
                src={`/Photography/${currentImage}.jpg`}
